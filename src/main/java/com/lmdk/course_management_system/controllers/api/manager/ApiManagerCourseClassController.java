...
@RestController
@RequestMapping("/api/manager/classes")
@RequiredArgsConstructor
public class ApiManagerCourseClassController {
    ...
    public AdminCourseClassPageResponse getClasses(
        ...
        return new AdminCourseClassPageResponse(
                classService.getClasses(params).stream().map(classMapper::toResponse).toList(),
                page, totalPages, totalRecords
        );
    }

    @PostMapping
    public AdminCourseClassActionResponse addClass(@RequestBody CourseClassRequest request) {
        ...
        return new AdminCourseClassActionResponse(courseClass.getId(), "Thêm lớp học thành công!");
    }
    ...
    public AdminCourseClassActionResponse updateClass(
        ...
        return new AdminCourseClassActionResponse(classId, "Cập nhật lớp học thành công!");
    }
    ...
    private CourseClass requireClass(Integer classId) {
        ...
        if(courseClass == null) throw new IllegalArgumentException("Không tìm thấy lớp học!");
        return courseClass;
    }

    private Course requireCourse(Integer courseId) {
        if(courseId == null) throw new IllegalArgumentException("Vui lòng chọn khóa học!");
        Course course = courseService.getCourseById(courseId);
        if(course == null) throw new IllegalArgumentException("Khóa học không tồn tại!");
        return course;
    }
